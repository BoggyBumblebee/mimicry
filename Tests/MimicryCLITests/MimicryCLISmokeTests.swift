...
final class MimicryCLISmokeTests: XCTestCase {
    ...
    func testApplyDryRunRendersActionPlanWithoutMutatingSystemState() throws {
        ...
        XCTAssertTrue(output.contains("Snapshot: \(packageURL.path)"))
        XCTAssertTrue(output.contains("Actions: 3"))
        ...
        XCTAssertTrue(output.contains("- requires user action: 0"))
        XCTAssertTrue(output.contains("SKIP"))
        XCTAssertTrue(output.contains("Environment metadata is informational and is not applied."))
        ...
        XCTAssertFalse(output.contains("REQUIRES USER ACTION"))
        XCTAssertFalse(output.contains("hostname: would change"))
        XCTAssertFalse(output.contains("username: would add"))
        XCTAssertTrue(output.contains("No system settings were changed."))
    }
