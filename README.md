...
Phase 0, Phase 1, Phase 2, and Phase 3 are done. Phase 4 has started with read-only Safari bookmark inventory. Mimicry can create, validate, richly inspect, diff, dry-run apply, and perform the first narrow confirmed apply from a `.mimicry` snapshot package containing environment, Homebrew, App Store, Finder, Terminal, iCloud, and Safari sections.
...
- Capability detection, Phase 2 providers for environment, Homebrew, and App Store inventory, Phase 3 providers for Finder, Terminal, and iCloud inventory, and the first Phase 4 Safari bookmark inventory provider.
